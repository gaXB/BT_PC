...
public:
	...
	//xb
	void EnsureVisible_xb(CCellID &cell)       { EnsureVisible_xb(cell.row, cell.col); }
    void EnsureVisible_xb(int nRow, int nCol);
	void EnsureVisible_Row_xb(int nRow,int nCol);
